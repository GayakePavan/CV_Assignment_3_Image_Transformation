...
# Set the Streamlit app background color 
st.markdown(
    """
    <style>
    body {
...
st.title("Apply the Affine Transformation")
...
if uploaded_image is not None:
    ...
    transform_type = st.selectbox("Please select Transformation", ["None", "Rotation", "Scaling", "Translation", "Shearing", "Affine"])
